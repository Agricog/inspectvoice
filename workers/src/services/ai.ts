...
const WORKER_ASSET_CONFIGS: Record<string, WorkerAssetTypeConfig> = {
  ...
  exercise_equipment: {
    key: 'exercise_equipment',
    name: 'Outdoor Exercise Equipment',
    complianceStandard: 'BS EN 16630:2015, BS EN 1176-1:2017, BS EN 1177:2018',
    inspectionPoints: [
      { label: 'Moving parts and mechanisms', description: 'Check all pivot points, pedals, handles, resistance mechanisms for wear, seizure, excessive play.', appliesTo: ['routine_visual', 'operational', 'annual_main'] },
      { label: 'Structural frame condition', description: 'Check all frame members, welds, and joints for cracks, corrosion, deformation.', appliesTo: ['routine_visual', 'operational', 'annual_main'] },
      { label: 'Seats and contact surfaces', description: 'Check seats, backrests, pads for cracks, splits, UV degradation, secure attachment.', appliesTo: ['routine_visual', 'operational', 'annual_main'] },
      { label: 'Handgrips and handles', description: 'Check all grips for security, wear, corrosion, rotation.', appliesTo: ['operational', 'annual_main'] },
      { label: 'Hydraulic/resistance systems', description: 'Check dampers, pistons, resistance bands for leaks, function, adjustment mechanism.', appliesTo: ['operational', 'annual_main'] },
      { label: 'Bolt connections and fixings', description: 'Check all visible bolts for tightness, corrosion, missing caps.', appliesTo: ['operational', 'annual_main'] },
      { label: 'User information signage', description: 'Verify instruction signage is present, legible, correct, and shows proper use posture.', appliesTo: ['operational', 'annual_main'] },
      { label: 'Foundation and ground fixings', description: 'Check base plates, anchor bolts, ground erosion around footings.', appliesTo: ['annual_main'] },
      { label: 'Entrapment and pinch points', description: 'Check all moving parts for finger, hand, and limb entrapment during operation.', appliesTo: ['annual_main'] },
      { label: 'Surfacing beneath equipment', description: 'Check surface condition around and beneath equipment for safe use.', appliesTo: ['routine_visual', 'operational', 'annual_main'] },
    ],
    riskCriteria: {
      very_high: ['Mechanism failure causing sudden release under load', 'Structural member failure or severe cracking', 'Entrapment hazard at moving parts', 'Sharp edge or protrusion from breakage', 'Seat or pedal detachment risk during use'],
      high: ['Significant corrosion on load-bearing members', 'Cracked pedal, seat, or handle housing', 'Hydraulic leak on resistance mechanism', 'Excessive play in pivot points', 'Missing or broken handgrip'],
      medium: ['Surface corrosion not yet affecting structure', 'Squeaking or stiff mechanisms (still functional)', 'Minor cracks in housings or covers', 'Signage faded or partially missing', 'Surfacing wear around equipment'],
      low: ['Cosmetic paint wear', 'Minor surface marks', 'Slight operational noise within tolerances'],
    },
    bsEnDefectCategories: [
      'BS EN 16630:2015 §4.2 — Structural requirements for outdoor fitness equipment',
      'BS EN 16630:2015 §4.3 — Moving parts and mechanisms',
      'BS EN 16630:2015 §4.4 — Entrapment and pinch points',
      'BS EN 16630:2015 §5 — User information requirements',
      'BS EN 1176-1:2017 §4.2.7 — Entrapment hazards',
    ],
  },
